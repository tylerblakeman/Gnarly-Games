...
function getAllGames() {
	...
	axios({
		...
		data:
			"fields id,name,genres,storyline,summary,screenshots,artworks,cover,aggregated_rating; limit 100;",
	})
		.then((response) => {
...
function getGamesbyArt(x) {
	...
	axios({
      ...
      //response contains image url and game id as game - turning into variable before sending to model
			var imgURL = `https://images.igdb.com/igdb/image/upload/t_cover_big/${response.data.image_id}.jpg`;
